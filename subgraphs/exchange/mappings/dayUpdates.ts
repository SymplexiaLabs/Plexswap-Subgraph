...
import { Pair, Bundle, Token, PlexFactory, PlexDayData, PairDayData, TokenDayData } from "../generated/schema";
...
export function updatePlexDayData(event: ethereum.Event): PlexDayData {
  ...
  let plexDayData = PlexDayData.load(dayID.toString());
  if (plexDayData === null) {
    plexDayData = new PlexDayData(dayID.toString());
    plexDayData.date = dayStartTimestamp;
    plexDayData.dailyVolumeUSD = ZERO_BD;
    plexDayData.dailyVolumeBNB = ZERO_BD;
    plexDayData.totalVolumeUSD = ZERO_BD;
